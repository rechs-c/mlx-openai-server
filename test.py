...
if __name__ == "__main__":
    model = MLX_LM("mlx-community/Qwen3-1.7B-4bit")
    # test tool streaming
    tools = [
        {
            "type": "function",
            "function": {
                ...
                "parameters": {
                    ...
                    "properties": {
                        "city": {
                            "type": "string",
                            "description": "The city to get the weather for (only 1 city)"
                        }
                    }
                }
            }
        ...
        },
        {
            ...
            "function": {
                "name": "get_ascii_code",
                "description": "Get the ASCII code of a character",
                "parameters": {
                    "type": "object",
                    "properties": {
                        "char": {
                            "type": "string",
                            "description": "The character to get the ASCII code for"
                        }
                    }
                }
            }
        },
        {
            ...
            "function": {
                "name": "cpp",
                "description": "Run a C++ code",
                "parameters": {
                    "type": "object",
                    "properties": {
                        "code": {
                            "type": "string",
                            "description": "The C++ code to run"
                        }
                    }
                }
            }
    ...
    messages = [
        {
            "role": "user",
            "content": "Write C++ code to run quick sort on array [1, 7, 4, 9, 12]"
        }
    ]
    response = model(messages, stream=True, chat_template_kwargs=chat_template_kwargs)
    for chunk in response:
        print(chunk.text, end="" flush=True)

'''
curl -X POST "https://mac5-9090.eternalai.org/v1/chat/completions" \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer d50b6ba5169ea538a71fe7b0685b755823a3746934fa3cc4k" \
  -d '{
    "messages": [
    {
        "role": "user",
        "content": "What is the ASCII code of }"
    }
    ],
    "chat_template_kwargs": {
...
curl -X POST "https://nvidia4090-65534.eternalai.org/v1/chat/completions" \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer d50b6ba5169ea538a71fe7b0685b755823a3746934fa3cc4k" \
  -d '{
        "messages": [
            {
            "role": "user",
            "content": "What is the weather in Hue, and what is the current time?"
            }
        ],
        "chat_template_kwargs": {
            "enable_thinking": true
